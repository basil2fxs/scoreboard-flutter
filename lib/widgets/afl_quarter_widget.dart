...
class AflQuarterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final numberOnly = app.config.aflQuarterNumberOnly;

    String qLabel(int n) => n == 0 ? 'Off' : (numberOnly ? '$n' : 'Q$n');
        ...
        children: [
          ...
          Row(
            children: [
              ...
              for (int i = 1; i <= 4; i++)
                _QBtn(label: qLabel(i), value: i, selected: q == i,
